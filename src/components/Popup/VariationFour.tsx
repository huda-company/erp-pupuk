...
const VariationFour: FC<PopupProps> = ({
  show,
  type = "normal",
  msg,
  icon,
  ...
  const classNamePopupBody =
    "bg-white border-[0.0625rem] border-beluga h-fit w-fit absolute z-50 box-border flex flex-col items-start gap-[0.625rem] rounded-[0.875rem] border px-[2rem] pb-[3.125rem] pt-[2rem]";
  const classNamePopupContent = "w-fit h-fit flex flex-col items-center";
  ...
  return (
    <>
      {show && (
        ...
        >
          <div className={clsxm(classNamePopupBody, popupBodyStyle)}>
            <div
              className={clsxm(
                ...
                {type === "normal" ? (
                  <>
                    ...
                    >
                      ...
                      >
                        {buttonCloseText ? buttonCloseText : "No"}
                      </Typography>
                    </Button>
                    <Button
                    ...
                    >
                      <Typography
                        ...
                        className="items-center leading-[1.813rem]"
                      >
                        {buttonSubmitText ? buttonSubmitText : "Yes"}
                      </Typography>
                    </Button>
                  </>
                ) : (
